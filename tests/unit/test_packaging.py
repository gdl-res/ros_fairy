"""The version is declared in two places; they must agree.
...
def test_version_declarations_agree():
    ...
    assert package_xml.findtext("version") == ros_fairy.__version__
    ...
    assert match.group(1) == ros_fairy.__version__
